    ...
    overflow-hidden' id='Footer'>
        ...
        justify-between items-start'>
            <div className='w-full md:w-1/3 mb-8 md:mb-0'>
                ...
                adipisicing elit. Ex minima, obcaecati dignissimos 
                consequatur porro laudantium alias dolore vel modi praesentium 
                omnis cupiditate nobis enim officiis eum, fuga soluta iste magni!</p>
            </div>
            ...
            <h3 className='text-white text-lg font-bold mb-4'>Subscribe To
            Our Newsletter</h3>
