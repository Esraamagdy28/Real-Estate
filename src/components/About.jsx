...
const About = () => {
  return (
    ...
    id='About'>
      ...
      className='underline underline-offset-4 decoration-1 under font-light'>Our 
      Brand</span></h1>
      ...
      <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20'>
        ...
        <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
          ...
          Perferendis hic mollitia laudantium alias fuga! Error, earum? Libero 
          rerum, veniam omnis dolorum error sint obcaecati consequuntur atque 
          sunt quo debitis temporibus!</p>
