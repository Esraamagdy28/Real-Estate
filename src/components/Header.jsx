...
const Header = () => {
  return (
    <div className='min-h-screen  mb-4 lg-cover bg-center flex
    items-center w-full overflow-hidden' style={{backgroundImage: "url('/header_img.png')"}} id='Header'>
       ...
       className='container text-center mx-auto py-4 px-6 md:px-20
        ...
        max-w-3xl font-semibold pt-20'>Explore homes thats fit your dreams
        </h2>
        <div className='space-x-6 mt-16'>
            <a href="#Projects" className='border border-white px-8 py-3 
            rounded'>Projects</a>
            <a href="#Contact" className='bg-blue-500 px-8 py-3 rounded'>Contact 
            Us</a>
        </div>
       </motion.div>
    </div>
